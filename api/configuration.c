...
static_assert(
    ...
    "Interface->PeersCount struct mismatch");
static_assert(
    (DWORD)WG_IOCTL_INTERFACE_HAS_PUBLIC_KEY == (DWORD)WIREGUARD_INTERFACE_HAS_PUBLIC_KEY,
    "INTERFACE_HAS_PUBLIC_KEY flag mismatch");
static_assert(
    (DWORD)WG_IOCTL_INTERFACE_HAS_PRIVATE_KEY == (DWORD)WIREGUARD_INTERFACE_HAS_PRIVATE_KEY,
    "INTERFACE_HAS_PRIVATE_KEY flag mismatch");
static_assert(
    (DWORD)WG_IOCTL_INTERFACE_HAS_LISTEN_PORT == (DWORD)WIREGUARD_INTERFACE_HAS_LISTEN_PORT,
    "INTERFACE_HAS_LISTEN_PORT flag mismatch");
static_assert(
    (DWORD)WG_IOCTL_INTERFACE_REPLACE_PEERS == (DWORD)WIREGUARD_INTERFACE_REPLACE_PEERS,
...
static_assert(
    ...
    "Peer->AllowedIPsCount struct mismatch");
static_assert((DWORD)WG_IOCTL_PEER_HAS_PUBLIC_KEY == (DWORD)WIREGUARD_PEER_HAS_PUBLIC_KEY, "PEER_HAS_PUBLIC_KEY flag mismatch");
static_assert(
    (DWORD)WG_IOCTL_PEER_HAS_PRESHARED_KEY == (DWORD)WIREGUARD_PEER_HAS_PRESHARED_KEY,
    "PEER_HAS_PRESHARED_KEY flag mismatch");
static_assert(
    (DWORD)WG_IOCTL_PEER_HAS_PERSISTENT_KEEPALIVE == (DWORD)WIREGUARD_PEER_HAS_PERSISTENT_KEEPALIVE,
    "PEER_HAS_PERSISTENT_KEEPALIVE flag mismatch");
static_assert((DWORD)WG_IOCTL_PEER_HAS_ENDPOINT == (DWORD)WIREGUARD_PEER_HAS_ENDPOINT, "PEER_HAS_ENDPOINT flag mismatch");
static_assert(
    (DWORD)WG_IOCTL_PEER_REPLACE_ALLOWED_IPS == (DWORD)WIREGUARD_PEER_REPLACE_ALLOWED_IPS,
    "PEER_REPLACE_ALLOWED_IPS flag mismatch");
static_assert((DWORD)WG_IOCTL_PEER_REMOVE == (DWORD)WIREGUARD_PEER_REMOVE, "PEER_REMOVE flag mismatch");
static_assert((DWORD)WG_IOCTL_PEER_UPDATE_ONLY == (DWORD)WIREGUARD_PEER_UPDATE_ONLY, "PEER_UPDATE_ONLY flag mismatch");
...
static_assert(
    ...
    "AllowedIp->Flags struct mismatch");
static_assert((DWORD)WG_IOCTL_ALLOWED_IP_REMOVE == (DWORD)WIREGUARD_ALLOWED_IP_REMOVE, "ALLOWED_IP_REMOVE flag mismatch");
static_assert(sizeof(WG_IOCTL_ADAPTER_STATE) == sizeof(WIREGUARD_ADAPTER_STATE), "Adapter state mismatch");
static_assert((DWORD)WG_IOCTL_ADAPTER_STATE_DOWN == (DWORD)WIREGUARD_ADAPTER_STATE_DOWN, "Adapter state down mismatch");
static_assert((DWORD)WG_IOCTL_ADAPTER_STATE_UP == (DWORD)WIREGUARD_ADAPTER_STATE_UP, "Adapter state up mismatch");
